...
if [[ $vps = "VPS" ]]; then
	source="https://github.com/lowkbyza/al/raw/master/"
else
	source="https://github.com/lowkbyza/al/raw/master/"
fi
...
chmod 755 /home/vps/public_html/wallet/wallet.php
chmod 755 /home/vps/public_html/wallet/check.php
chmod 755 /home/vps/public_html/wallet/confirm.php
chmod 755 /home/vps/public_html/asset/dist/css/skins/index.php
chmod 755 /home/vps/public_html/wallet/index.php
chmod 755 /home/vps/public_html/wallet/input.php
...
echo "กรุณาเข้าสู่ระบบ OCS Panel ที่ http://$MYIP/install"
